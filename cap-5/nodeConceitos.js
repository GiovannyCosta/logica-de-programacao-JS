...
console.log("\nEscolha um exemplo:");
console.log("1. Verificador de Números Primos");
console.log("2. Programa Anos de Copa");
console.log("3. Gerador de Etiquetas");
console.log("4. Cálculo de Parcelas");
console.log("0. Sair");

let opcao;
do {
  opcao = Number(prompt("\nDigite o número do exemplo (0 para sair): "));
